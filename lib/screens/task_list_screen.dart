  ...
  List<Task> get _filteredTasks {
    switch (_filter) {
      ...
      case 'completed':
        return _tasks.where((t) => t.completed).toList();
      case 'nearby':
        // O filtro de proximidade é aplicado em _filterByNearby, que já atualiza _tasks
        return _tasks;
      default:
        return _tasks;
    }
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Theme.of(context).colorScheme.primary.withAlpha(204), Theme.of(context).colorScheme.primary],
                      ),
